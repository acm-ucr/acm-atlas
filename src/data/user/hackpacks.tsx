import {
  ...
  export const TECH_COLORS: Record<string, string> = {
    ...
    Arduino: "bg-green-200 text-green-900",
    Python: "bg-blue-200 text-blue-900",
    Unity: "bg-gray-300 text-gray-900",
    "C++": "bg-blue-300 text-blue-900",
    ...
    Jupyter: "bg-orange-200 text-orange-900",
    Pandas: "bg-gray-200 text-gray-900",
  };
