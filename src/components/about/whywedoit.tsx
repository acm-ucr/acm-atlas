...
const WhyWeDoIt = () => {
  return (
    <div className="mx-auto grid w-5/6 grid-cols-1 items-center gap-8 py-[4vh] md:py-[10vh] md:grid-cols-2">
      ...
      <div className="order-1 text-center md:order-2">
        ...
        <p className="text-xl md:text-2xl leading-10 text-acm-gray-500">
