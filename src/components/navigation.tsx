...
const Navigation = () => {
  ...
  return (
    <div className="sticky top-0 z-20 grid grid-cols-4 overflow-hidden border-acm-blue-400 bg-white p-5 shadow-xl md:grid-cols-5 md:border-b-2 md:border-b-acm-blue-600">
      <RiMenu2Fill
