      ...
      <div className="flex w-full flex-col sm:h-full lg:h-full">
        <div className="flex gap-5">
          <div className="sm:hidden">
            <div className="text-center text-base font-light uppercase text-[#DDF0FE]">
              {day}
            </div>
            <div className="-mt-2 text-4xl font-light text-[#E8EDF3]">
              {date}
            </div>
          </div>
          <div className="w-full">
            <div className="flex flex-row justify-between">
              <div className="mb-1 justify-start text-xl font-light text-white sm:pb-0 sm:pt-10 sm:text-2xl lg:text-3xl">
                {title}
              </div>
              <button
                onClick={() => setIsExpanded((prev) => !prev)}
                className="rounded-full p-2 text-blue-100 transition hover:bg-white/20 sm:hidden"
              >
