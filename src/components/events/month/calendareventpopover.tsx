...
const CalendarEventPopover = ({
  ...
  return (
    <Dialog>
      <DialogTrigger
        className={`flex w-full cursor-pointer justify-between py-1 ${eventType === "general" ? "bg-acm-blue-700 !text-white" : ""} ${eventType === "spark" ? "bg-acm-yellow-200 text-acm-gray-500" : ""} ${eventType === "forge" ? "bg-acm-gray-800 text-acm-gray-500" : ""} ${eventType === "create" ? "bg-acm-blue-200 text-acm-gray-500" : ""} ${eventType === "das" ? "bg-acm-purple-300 text-acm-gray-500" : ""} ${eventType === "bitbyte" ? "!bg-acm-green-500 text-acm-gray-500" : ""} text-left hover:opacity-75`}
      >
