...
const ImageCard = ({ image, alt, description }: ImageCard) => {
  return (
    <div className="group relative h-full p-2 text-acm-blue-500 sm:p-0">
      ...
      />
      <div className="absolute bottom-0 z-10 flex h-1/3 w-full items-end rounded-3xl bg-blue-fade opacity-0 transition-opacity duration-200 group-hover:opacity-100">
