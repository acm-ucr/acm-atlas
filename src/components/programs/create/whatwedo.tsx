...
const WhatWeDo = () => {
  return (
    <div className="relative mx-auto flex flex-col pb-[20vh] pt-[15vh]">
      ...
      <div className="relative z-10 mx-auto w-5/6">
        <div className="absolute right-[-25%] top-[-10%] -z-10 h-[500px] w-[500px] rounded-full bg-acm-blue-800 opacity-70 blur-3xl" />
        ...
        <div className="grid grid-cols-2 gap-x-14 gap-y-16">
          <div className="flex flex-col items-center justify-center text-right text-acm-gray-500">
            <p className="mt-5 w-5/6 text-2xl font-medium leading-normal">
              ...
              about design. By the end of the program, the website design will
              be finalized and ready for implementation by Spark in the
              following quarter.
            </p>
          </div>
