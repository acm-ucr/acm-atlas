  ...
  return (
    <div>
      <div className="mx-auto hidden w-3/4 justify-center py-12 text-left md:flex">
        <div className="pr-12">
          <StatItem end={110} label="quarterly applications" duration={0.7} />
        </div>
        <div className="border-l-2 pl-4 pr-8">
          <StatItem end={45} label="total acceptances" duration={0.7} />
        </div>
        <div className="border-l-2 pl-4 pr-12">
          <StatItem end={54} label="projects" duration={0.7} />
        </div>
      </div>
