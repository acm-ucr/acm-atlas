  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          The program is ten weeks long, beginning at the start of UCR's quarter
          system and ending at its end.
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-8">
        ...
        <AccordionContent>
          Everyone can apply, regardless of whether you are from UCR or another
          school.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
