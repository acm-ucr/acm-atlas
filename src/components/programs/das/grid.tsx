        ...
        <div className="mx-auto grid w-10/12 grid-cols-12 items-center">
            ...
            <div className="col-span-5">
                <div className="flex flex-col">
                    ...
                    <p className="flex justify-center text-3xl font-medium text-acm-gray-500 w-9/12">
                        DAS aims to analyze, experiment, and explore data across
                        various of fronts and domains! Our goal is to expose you to skills
                        working with big data ranging from statistical hypothesis testing to
