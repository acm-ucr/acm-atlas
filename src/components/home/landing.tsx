...
const Landing = () => {
  return (
    <div className="text-acm-gray-500 relative mt-10 flex flex-col items-center justify-center text-6xl font-semibold">
      ...
      <div className="z-999 mt-16 grid w-1/2 grid-cols-2 items-center justify-items-center -space-x-4 rounded-lg bg-[#F6F6F6] p-20 opacity-100">
        <Image
          src={top}
          alt="top"
          className="absolute right-[25%] bottom-[20%] h-[500px] w-[900px] rounded-3xl"
        />
        <div className="absolute top-[51%] right-[68%] z-24 h-[25px] w-[25px] rounded-full bg-[#F6F6F6]"></div>
        <div className="absolute top-[51%] right-[70%] z-24 h-[25px] w-[25px] rounded-full bg-[#F6F6F6]"></div>
        <div className="absolute top-[51%] right-[72%] z-24 h-[25px] w-[25px] rounded-full bg-[#F6F6F6]"></div>
